...
class $SchedulesTable extends Schedules
  ...
  static const VerificationMeta _cotnentMeta =
      const VerificationMeta('cotnent');
  @override
  late final GeneratedColumn<String> cotnent = GeneratedColumn<String>(
      'cotnent', aliasedName, false,
  ...
  List<GeneratedColumn> get $columns =>
      [id, cotnent, date, startTime, endTime, colorId, createdAt];
  @override
  ...
  VerificationContext validateIntegrity(Insertable<Schedule> instance,
    ...
    if (data.containsKey('cotnent')) {
      context.handle(_cotnentMeta,
          cotnent.isAcceptableOrUnknown(data['cotnent']!, _cotnentMeta));
    } else if (isInserting) {
      context.missing(_cotnentMeta);
    }
  ...
  Schedule map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Schedule(
      ...
      cotnent: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}cotnent'])!,
...
class Schedule extends DataClass implements Insertable<Schedule> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['cotnent'] = Variable<String>(cotnent);
  ...
  factory Schedule.fromJson(Map<String, dynamic> json,
    ...
    return Schedule(
      ...
      cotnent: serializer.fromJson<String>(json['cotnent']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'cotnent': serializer.toJson<String>(cotnent),
  ...
  @override
  int get hashCode =>
      Object.hash(id, cotnent, date, startTime, endTime, colorId, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Schedule &&
          other.id == this.id &&
          other.cotnent == this.cotnent &&
...
class SchedulesCompanion extends UpdateCompanion<Schedule> {
  ...
  const SchedulesCompanion({
    ...
    this.cotnent = const Value.absent(),
  ...
  static Insertable<Schedule> custom({
    ...
    return RawValuesInsertable({
      if (id != null) 'id': id,
      if (cotnent != null) 'cotnent': cotnent,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (cotnent.present) {
      map['cotnent'] = Variable<String>(cotnent.value);
    }
    if (date.present) {
